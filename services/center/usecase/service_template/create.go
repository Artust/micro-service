...
func Create(
	...
	input *pb.CreateServiceTemplateRequest,
	...
	createdServiceTemplat, err := session.WriteTransaction(func(tx neo4j.Transaction) (interface{}, error) {
		ctx = context.WithValue(ctx, config.Neo4jTransactionContextKey, tx)
		serviceTemplate, err := serviceTemplateRepository.Create(ctx, &data)
		if err != nil {
	...
	serviceTemplate := createdServiceTemplat.(entity.ServiceTemplate)
